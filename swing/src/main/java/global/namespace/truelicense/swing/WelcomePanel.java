...
import global.namespace.truelicense.swing.util.EnhancedRadioButton;
...
final class WelcomePanel extends LicensePanel {
    ...
    private void initComponents() {
        ...
        installButton = new EnhancedRadioButton();
        displayButton = new EnhancedRadioButton();
        uninstallButton = new EnhancedRadioButton();
        ...
        prompt.setText(format(LicenseWizardMessage.welcome_prompt)); // NOI18N
        prompt.setWrapStyleWord(true);
        prompt.setBorder(null);
        prompt.setName(LicenseWizardMessage.welcome_prompt.name());
        ...
        installButton.setText(format(LicenseWizardMessage.welcome_install)); // NOI18N
        installButton.setActionCommand(LicenseWizardState.install.name());
        installButton.setName(LicenseWizardMessage.welcome_install.name());
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        displayButton.setText(format(LicenseWizardMessage.welcome_display)); // NOI18N
        displayButton.setActionCommand(LicenseWizardState.display.name());
        displayButton.setName(LicenseWizardMessage.welcome_display.name());
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        uninstallButton.setText(format(LicenseWizardMessage.welcome_uninstall)); // NOI18N
        uninstallButton.setActionCommand(LicenseWizardState.uninstall.name());
        uninstallButton.setName(LicenseWizardMessage.welcome_uninstall.name());
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
