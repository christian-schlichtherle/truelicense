...
public final class ObfuscatedString {
     ...
     * {@code "new org.truelicense.obfuscate.runtime.ObfuscatedString(new long[] {
    ...
    public static String java(final long[] obfuscated) {
        ...
        final StringBuilder code = new StringBuilder(new ObfuscatedString(new long[] {
                0x3b538a33717b18b3l, 0x8ae3b936b10951d4l, 0x85cfddfea813f6edl,
                0x68afb497e1ccb1a1l, 0x7e1db30645eb65e7l, 0x5a1083ca6c5696a7l,
                0x82c29477374881cdl, 0x607119968158dcb1l, 0x77da08afec88f473l
        }).toString()); /* => "new org.truelicense.obfuscate.ObfuscatedString(new long[] { " */
