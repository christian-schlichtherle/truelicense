...
/**
 * A repository controller for use with V2/XML format license keys.
 */
final class V2XmlRepositoryController implements RepositoryController {

    private final Codec codec;
    private final V2XmlRepositoryModel model;

    V2XmlRepositoryController(final Codec codec, final V2XmlRepositoryModel model) {
