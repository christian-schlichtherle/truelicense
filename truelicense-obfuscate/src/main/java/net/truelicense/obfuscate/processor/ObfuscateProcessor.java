 ...
 * {@code net.truelicense.obfuscate.verbose} or
 * {@code net.truelicense.obfuscate.processor.verbose}
...
@SupportedAnnotationTypes("Obfuscate")
@SupportedOptions({
    "net.truelicense.obfuscate.verbose",
