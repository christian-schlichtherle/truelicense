 ...
 * implementation of the {@link net.truelicense.api.io.Store} interface.
 * License keys pass the following life cycle phases as defined by the interfaces
 * {@link net.truelicense.api.VendorLicenseManager} and {@link net.truelicense.api.ConsumerLicenseManager}:
 * <ol>
 ...
 * </ol>
 * <p>
 * A license bean is an instance of the {@link net.truelicense.api.License} class.
 ...
 * These properties get {@linkplain net.truelicense.api.LicenseInitialization#initialize initialized} and
 * {@linkplain net.truelicense.api.LicenseValidation#validate validated} whenever a license key gets generated.
 ...
 * {@code @net.truelicense.obfuscate.Obfuscate} and processible with the TrueLicense Maven Plugin for simple, reliable
 * obfuscation of constant string values in the byte code for license applications.
 * <p>
